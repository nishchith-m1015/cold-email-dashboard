/**
 * DropdownMenu - Radix UI based dropdown menu component
 * 
 * A simple dropdown menu for touch-friendly action menus.
 * Used as a replacement for context menus on mobile.
 */
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'text-text-primary focus:bg-surface-elevated focus:text-text-primary',
